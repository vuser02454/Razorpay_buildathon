...
import { ShieldCheck, Mail, ArrowRight, ArrowLeft, Loader2, CheckCircle2, Sun, Moon, KeyRound } from 'lucide-react';
      ...
      <main className="relative z-10 max-w-md w-full mx-auto px-4 py-6 sm:py-8 animate-fade-up">
        <div className={`backdrop-blur-xl border rounded-3xl p-6 sm:p-8 shadow-2xl transition-all duration-300 space-y-6 ${
          ...
          <div className="text-center space-y-2">
            <div className="w-12 h-12 mx-auto rounded-2xl bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center text-indigo-500 shadow-sm">
          ...
          {success ? (
            <div className="space-y-5 animate-fade-in text-center">
              <div className="p-4 rounded-2xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-600 dark:text-emerald-300 text-xs font-semibold space-y-2">
