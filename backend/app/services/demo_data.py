...
# Realistic Customer Names and Individual Gmail Addresses for Testing
NAMES = [
    ("Rahul Sharma", "rahul.test@gmail.com", "+91 98201 44521", "IN", CustomerSegment.PRO, 28000.0, 14, 0.94),
    ("Priya Venkatesh", "priya.test@gmail.com", "+91 99402 11849", "IN", CustomerSegment.ENTERPRISE, 64000.0, 22, 0.97),
    ("Ananya Patel", "ananya.test@gmail.com", "+91 98791 22301", "IN", CustomerSegment.STARTER, 9999.0, 6, 0.88),
    ("Amitabh Mukherjee", "amitabh.test@gmail.com", "+91 98310 99402", "IN", CustomerSegment.PRO, 36000.0, 18, 0.92),
    ("Sneha Deshmukh", "sneha.test@gmail.com", "+91 98220 55194", "IN", CustomerSegment.PRO, 21000.0, 9, 0.91),
    ("Vikram Singhania", "vikram.test@gmail.com", "+91 98110 33481", "IN", CustomerSegment.ENTERPRISE, 85000.0, 28, 0.98),
    ("Rohan Dasgupta", "rohan.test@gmail.com", "+91 98450 77123", "IN", CustomerSegment.STARTER, 7500.0, 4, 0.85),
    ("Deepika Nair", "deepika.test@gmail.com", "+91 94470 66320", "IN", CustomerSegment.PRO, 31000.0, 12, 0.93),
    ("Karan Malhotra", "karan.test@gmail.com", "+91 98100 88219", "IN", CustomerSegment.ENTERPRISE, 55000.0, 16, 0.95),
    ("Pooja Sundaram", "pooja.test@gmail.com", "+91 99440 22718", "IN", CustomerSegment.PRO, 19500.0, 8, 0.90),
    ("Siddharth Roy", "siddharth.test@gmail.com", "+91 98200 44102", "IN", CustomerSegment.STARTER, 11000.0, 7, 0.87),
    ("Tanvi Joshi", "tanvi.test@gmail.com", "+91 98230 11982", "IN", CustomerSegment.PRO, 24500.0, 11, 0.92),
    ("Arjun Reddy", "arjun.test@gmail.com", "+91 98490 33201", "IN", CustomerSegment.ENTERPRISE, 72000.0, 20, 0.96),
    ("Meera Nambiar", "meera.test@gmail.com", "+91 94460 77192", "IN", CustomerSegment.PRO, 18000.0, 9, 0.89),
    ("Gaurav Kapoor", "gaurav.test@gmail.com", "+91 98111 66203", "IN", CustomerSegment.STARTER, 8500.0, 5, 0.84),
    ("Nisha Gupta", "nisha.test@gmail.com", "+91 98710 44810", "IN", CustomerSegment.PRO, 26000.0, 13, 0.93),
    ("Varun Chadha", "varun.test@gmail.com", "+91 98102 99182", "IN", CustomerSegment.ENTERPRISE, 68000.0, 24, 0.98),
    ("Swati Hegde", "swati.test@gmail.com", "+91 98800 22391", "IN", CustomerSegment.PRO, 22500.0, 10, 0.91),
    ("Aditya Verma", "aditya.test@gmail.com", "+91 98290 88301", "IN", CustomerSegment.STARTER, 12500.0, 7, 0.86),
    ("Ritu Banerjee", "ritu.test@gmail.com", "+91 98300 55192", "IN", CustomerSegment.PRO, 29000.0, 15, 0.94),
    ("David Miller", "david.test@gmail.com", "+1 415 882 1092", "US", CustomerSegment.ENTERPRISE, 92000.0, 30, 0.98),
    ("Sarah Jenkins", "sarah.test@gmail.com", "+44 20 7946 0912", "GB", CustomerSegment.PRO, 34000.0, 14, 0.92),
    ("Rajesh Kulkarni", "rajesh.test@gmail.com", "+91 98221 33490", "IN", CustomerSegment.PRO, 25000.0, 11, 0.93),
    ("Ankit Agrawal", "ankit.test@gmail.com", "+91 98291 44021", "IN", CustomerSegment.STARTER, 9000.0, 5, 0.87),
    ("Divya Menon", "divya.test@gmail.com", "+91 94471 22849", "IN", CustomerSegment.PRO, 27500.0, 12, 0.92),
]
